...
# def fighting_stance():
#     detect_pose_live()
#     return {"message": "Finished live stream."}
...
def fighting_stance():
    ...
    return {"message": "live streaming."}

def run_fastapi():
    uvicorn.run("api3:app", host="localhost", port=8000, reload=True)

# Function to run Streamlit
# def run_streamlit():
#     subprocess.run([sys.executable, "-m", "streamlit", "run", "detect_pose_streamlit.py", "--server.port=8501"])
